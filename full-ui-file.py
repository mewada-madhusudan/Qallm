...
class DocumentExtractionUI:
    ...
    def start_processing(self):
        ...
        if not self.input_file_path or not os.path.exists(self.input_file_path):
            ...
            messagebox.showerror("Input Error", "Please select a valid input Excel file")
            return
            
        if not self.output_file_path:
            logging.error("Output file not specified")
            messagebox.showerror("Output Error", "Please specify an output Excel file")
            return
    ...
    def process_data(self):
        ...
        try:
            ...
            if not results["success"]:
                ...
                self.root.after(0, lambda: messagebox.showerror("Processing Error", f"Failed to process Excel file: {error_msg}"))
            ...
            if not export_success:
                ...
                self.root.after(0, lambda: messagebox.showerror("Export Error", "Failed to export results to Excel file"))
            else:
                logging.info("Processing completed successfully")
                self.root.after(0, lambda: messagebox.showinfo("Success", f"Processing completed successfully. Results exported to {self.output_file_path}"))
